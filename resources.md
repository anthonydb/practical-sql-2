...
[MADlib](https://madlib.apache.org/): A machine learning and analytics library for large data sets.
...
[PostGIS Blog](https://postgis.net/news/): Announcements and updates on the PostGIS extension covered in Chapter 15.
...
Other good resources for documentation are the [Postgres Guide](https://postgresguide.com/) and [Stack Overflow](https://stackoverflow.com/questions/tagged/postgresql/), where you can find questions and answers posted by developers. You can also check out the Q&A site for [PostGIS](https://gis.stackexchange.com/questions/tagged/postgis/).
